$(document).ready(function() {
    ...
    document.querySelector('input[name="senha"]').addEventListener('input', markChanges);
    document.querySelector('select[name="user_tipo"]').addEventListener('change', markChanges);
            ...
            success: function(response) {
                ...
                if (response === "success") {
                    Swal.fire({
                        ...
                        // Recarrega a página para atualizar a tabela de usuários
