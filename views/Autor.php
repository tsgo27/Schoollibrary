                ...
                <div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="../Models/Insert_Autor.php" id="cadastroForm">
                            <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>" autocomplete="off">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Autor</label>
                                        <input type="text" name="addAutor" id="addAutor" maxlength="80" class="form-control" required>
                                        <label>Status</label>
                                        <select name="addStatus" id="addStatus" maxlength="7" class="form-control" required>
