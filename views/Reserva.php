                                        ...
                                        if ($result->rowCount() > 0) {
                                            while ($user_data = $result->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                echo "<td class='col-lg-3'>
                                                    <a href='#editEmployeeModal' class='edit editarReserva btn btn-warning' data-toggle='modal'>Editar</a>
                                                    <!--button class='delete excluirReserva btn btn-danger excluir-button' data-cod-reserva='{$user_data['CodReserva']}'>Excluir</button-->
                                                    </td>";
                                                echo "</tr>";
                                            }
                                        } else {
...
<!---------Popup Adicionar Reservas-Start------------->
                <div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="../Models/Insert_Reservas.php" id="cadastroForm">
...
<!---------Popup Acervo Reservas--END----------------->



<!---------Popup Editar Reservas-Start----------------->
                <div class="modal fade" tabindex="-1" id="editEmployeeModal" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="../Models/Update_Reservas.php" id="cadastroFormu">
                            <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>" autocomplete="off">
                                <div class="modal-body">
                                    <div class="form-group">
